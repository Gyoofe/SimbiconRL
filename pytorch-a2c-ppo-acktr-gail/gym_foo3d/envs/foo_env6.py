...
class FooEnv6(env_base.FooEnvBase):
    ...
    def step(self, action):
        ...
        reward = (alive_bonus - self.tausums/16000 -2*rootPenalty - np.abs(pos_after[2]) - 10*StepLengthPenalty - 10*FootHeightPenalty - 15*stepDurationPenalty - 8*torsoUprightPenalty)/(3/self.desiredStepDuration)
