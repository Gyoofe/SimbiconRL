...
class FooEnv6(env_base.FooEnvBase):
    ...
    def step(self, action):
        ...
        reward = (alive_bonus - 2*rootPenalty - self.tausums/64000 - np.abs(pos_after[2]) - 12*StepLengthPenalty - 10*FootHeightPenalty - 15*stepDurationPenalty - 8*torsoUprightPenalty)/(3/self.desiredStepDuration)
